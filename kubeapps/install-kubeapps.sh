...
ytt -f  $WORKING_DIR/integrate-contour-overlay.yaml -f $WORKING_DIR/chart.yaml -f $1 -f $pull_secret --file-mark 'chart.yaml:type=yaml-plain' > $WORKING_DIR/install.yaml
kubectl delete -f $WORKING_DIR/install.yaml -n kubeapps
kubectl apply -f kubeapps-dependencies.yaml
